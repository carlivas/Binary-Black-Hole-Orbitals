...
class Particle:
    ...
    def __init__(self, name, mass, radi, spin): #Add lane endem equation so I can find the value of the radius with just the mass
        ...
        k2ns = 0.259909    #Neutron Star: Index range n = [0.5, 1]. For n=0.5, k = 0.449154. For n=2/3, k = 0.375966. For n=1, k = 0.259909.
        ...
        if name == "BH":
            ...
            self.mass = mass
            self.spin = spin
            self.radisch = (2*G_new_SI*self.mass*M_sun_SI/c_SI**2)/R_bull_SI
